    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          FlatButton(
            child: Text('¿Ya tienes cuenta? Login', style: TextStyle(color: Color.fromRGBO(169, 80, 162, 1.0))),
        ...
        Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              Text('Miguel Martínez', style: TextStyle(color: Colors.white, fontSize: 25.0))
            ],
          )
        )
      ],
